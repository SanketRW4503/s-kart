    ...
    return (
        <div>
              <ToastContainer
                ...
                theme="light"
                />
            <h1 className='text-[40px] mx-[10%] max-[1000px]:mt-6'>Cart {totalItems}</h1>

            <section className='flex mx-[10%] justify-between max-[800px]:justify-center mt-[30px] flex-wrap '>
                ...
                <div className='flex flex-col flex-wrap '>

                    {
                        cart_data.length > 0 ?
                            cart_data.map((e) => {
                                return <div className='flex border p-[30px] m-4 flex-wrap justify-center'>
                                    <div>
                                        <img src={e.image} className='w-[200px] h-[200px]' />

                                    </div>
                                    <div className='ml-[30px] max-[800px]:ml-[0px]'>
                                        ...
                                        <div className=' mt-8 flex flex-wrap justify-center'>
                                          ...
                                          <button className='ml-[50px] max-[800px]:ml-[0px] max-[800px]:mt-[20px] bg-blue-300  px-4 rounded-lg' onClick={() => remove_item(e)}>Remove From Cart</button>
                ...
                {
                    cart_data.length > 0 ?
                        <div className='w-[40%] ml-8 mb-3  max-[800px]:ml-0 max-[800px]:w-[max-content]'>
            ...
            </section>
            {
                cart_data.length == 0 ? <div className=' justify-center  flex flex-col items-center mb-[100px]'>
                    ...
                    <h1 className='font-semibold text-[30px]'>Your Cart is Empaty</h1>
                    <small className='text-[12px]'>Please Add Something to make me happy !</small>
